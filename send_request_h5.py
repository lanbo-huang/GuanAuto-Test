...
class SendRequests():
    ...
    def __init__(self):
        ...
        self.header = {"Eaton-Company-CODE":"MCGS", "Eaton-Origin": "STANDARDH5",'Content-Type': 'application/json;charset=UTF-8',"User-Agent": "Apache-HttpClient/4.5.7 (Java/1.8.0_191)"}
        self.phone ="13300000108"

        '''self.headers ={
            'Eaton-Origin': 'H5',
            'Eaton-Company-CODE': 'MCGS',
            'Content-Type': 'application/json;charset=UTF-8',
            'Eaton-ORG-ID': '1206346874605690882'  # 对应登录账户的权限ID
        }
        self.data={'phone':'13300000018','code':'6666','loginType':'2'}
